...
public class data {
    public static NavDrawerItem[] navtitles={new NavDrawerItem("Schedule", R.drawable.schedule),
    ...
    public static NavDrawerItem[] navtitles_notloggedin={new NavDrawerItem("Schedule", R.drawable.schedule),
            new NavDrawerItem("FAQ",R.drawable.faq)};
